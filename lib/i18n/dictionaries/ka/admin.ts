export const admin = {
  ...
  enrich: {
    ...
    description:
      "ხელახლა კითხულობს OpenStreetMap-ს და, სადაც ჩანაწერს მხოლოდ კოორდინატები აქვს, ადგილმდებარეობით ეძებს ქუჩას. შეავსებს ცარიელ მისამართს, ქალაქს, უბანს, საიტსა და სამუშაო საათებს. არსებულ მონაცემს არ გადააწერს. ტელეფონი ამ წყაროებში არ არის.",
    preview: "შემოწმება",
    ...
    geocodeCapped: "ერთ გაშვებაზე მისამართების ლიმიტია; დარჩენილია (გაუშვი ხელახლა):",
