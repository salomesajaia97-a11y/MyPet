          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-medium text-gray-600">{t.admin.users.cols.email}</th>
                <th className="text-left px-4 py-3 font-medium text-gray-600">{t.admin.users.cols.role}</th>
                <th className="text-left px-4 py-3 font-medium text-gray-600">{t.admin.users.cols.joined}</th>
